...
Die Homepage in Abbildung \ref{fig:homepageMockup} ist auf die Rolle eines \hyperref[editor]{Editors} zugeschnitten, wobei dieser auch einige
Reviews bearbeitet und somit auch die Rolle des \hyperref[review]{Gutachters} für einige Paper bekleidet.
Dabei werden bei den Papers die verschiedenen Rollen durch R und E gekennzeichnet.

Die Paper Site in Abbildung \ref{fig:paperMockup} ist auf die Rolle eines \hyperref[authentifiziert]{authentifizierten Nutzenden} ausgelegt.
...
Hierbei wird jedoch wie folgt unterschieden: Der Header ist nur für \hyperref[authentifiziert]{authentifizierte Nutzer} zugänglich,
...
Im Diagramm werden \hyperref[admin]{Administratoren}, \hyperref[editor]{Editoren}, \hyperref[review]{Gutachter} und normale Nutzende unter dem allgemeinen Begriff

...
\begin{itemize}
	\item \emph{Entwicklerrechner}: Die Entwickler verwenden folgende Systeme für die Entwicklung:
		...
		\end{itemize}
	\item \emph{IDE \todo{Glossar}}: JetBrains IntelliJ 2021.2
	\item \emph{JDK \todo{Glossar}}: Adopt-OpenJDK 16.0.1
	\item \emph{Application Server}: Tomcat 10
	\item \emph{Build Tool \todo{Glossar}}: Apache Maven 3.6.3
	\item \emph{Testing Frameworks}: JUnit 5, Selenium 3, Mockito
	\item \emph{In-Memory Datenbank \todo{Glossar}}: H2 Database Engine
...
\begin{itemize}
	...
	\item \emph{Zusammenarbeit} im Team wird über den \emph{GitLab \todo{Glossar}} Server der Fakultät für Informatik und Mathematik der Universität Passau gehandhabt.
\end{itemize}
\subsection{Dokumente}
\begin{itemize}
	\item \emph{Textsatz}: \LaTeX \todo{Glossar}
...
\begin{itemize}
	\item \emph{Klassendiagramm \todo{Glossar}}: IBM Rational Software Architect 9.7 auf Debian 11
	\item \emph{Vektorgrafik Software \todo{Glossar}}: Inkscape 1.1.1

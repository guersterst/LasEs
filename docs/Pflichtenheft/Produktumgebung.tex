...
\begin{itemize}
	...
	\item \textbf{Server:} Rechner mit Internetanschluss, um darauf Webserver und Datenbankserver laufen zu lassen. Datenbankserver und Anwendungsserver können auch auf zwei unterschiedlichen Rechnern ausgeführt werden. Getestet wird mit einem Setup, in dem Datenbankserver und Anwendungsserver getrennt sind.\\

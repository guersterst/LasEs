...
\hyperref[glo:gutachter]{Gutachtern}, \hyperref[glo:editor]{Editoren} und \hyperref[glo:admin]{Administratoren} zur Verfügung stehen.
...
\begin{description}
    ...
    an.
    Der Editor wird nach erfolgreicher Erstellung hierüber durch eine automatisierte Mail informiert.
...
\begin{description}
    ...
    zugeordnet ist.
    Für sie gelten \hyperref[nut:start]{dieselben Funktionalitäten} wie für die Einreichungen.
\end{description}
...
\begin{description}
    ...
    \begin{itemize}
        ...
        \item  Die Kategorie (Physik, Chemie \ldots) kann aus existierenden ausgewählt oder neu erstellt werden.
        \item Bei der Angabe von Editoren wird überprüft, dass diese bereits als Nutzer im System registriert sind.

...
%link
\textit{anonymer Nutzer}, \textit{angemeldeter Nutzer}, \texit{Gutachter}, \textit{Editor}, und
...
\begin{description}
    ...
    Daten aufgefordert. Verlangt wird die Eingabe eines Passworts, %link /D/
...
\begin{description}
    ...
    \XXitem{/F210/}{funkt:210} Bei Änderung der Mailadresse wird der E-Mailverifikationsprozess erneut
...
\begin{description}
    ...
    Name, Kurzbeschreibung, Editoren, potentielle Deadlines und Website angezeigt. %link /D/
...
\begin{description}
    ...
    %link /D/
    und Einreichungen aus dem System entfernt. %link /D/
\end{description}
...
\begin{description}
    ...
    'Look and Feel' des Systems festlegen. Hierzu bestimmt der die Daten wie in definiert. %link /D/
\end{description}
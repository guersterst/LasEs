...
Die Notation \texttt{/FXXX/} erlaubt eine spätere Referenzierung der einzelnen Produktfunktionen in diesem und weiteren
Dokumenten. \texttt{/FXXX/} steht dabei für Musskriterien, \texttt{/FWXXX/} für Wunschkriterien. \texttt{XXX} entspricht dabei immer einer dreistelligen Zahl. Diese Konvention wird in den folgenden Abschnitten fortgeführt.
...
\begin{description}
    ...
    sowie den gewünschten Editor, durch ein Dropdown-Menü, an. Der Editor wird nach erfolgreicher Einreichung hierüber durch eine
...
\begin{description}
    \XXitem{/F600/}{funkt:600} Ein Editor kann auf die Nutzerliste umgesetzt nach \hyperref[leist:40]{/L040/} über die Kopfzeile zugreifen.
...
\begin{description}
    ...
    \XXitem{/F660/}{funkt:660} Ein Editor kann, in einem wissenschaftlichen Forum welcher er als Editor zugeordnet ist,
...
\begin{description}
    ...
    \XXitem{/F685/}{funkt:685} Ein Editor kann noch nicht freigeschaltete Gutachten einsehen und freischalten.

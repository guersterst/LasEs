...
%todo kategorien wer entscheidet und wie?
...
\begin{description}
    ...
    \begin{itemize}
        ...
        \item  Die Kategorie (Algorithmik, Graphentheorie, Analysis, \ldots) kann aus existierenden ausgewählt oder neu erstellt werden.

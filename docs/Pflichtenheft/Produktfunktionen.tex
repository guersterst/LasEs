...
\hyperref[glo:editor]{Editoren} und \hyperref[glo:admin]{Administratoren}, zur Verfügung stehen.
...
\begin{description}
    ...
    wird dieser auf die Anmelde- und Willkommensseite weitergeleitet. Ausgenommen davon ist die Registrierungsseite.
...
\begin{description}
    \XXitem{/F050/}{funkt:050} Ein anonymer Nutzer kann von der Anmelde- und Willkommensseite aus mittels eines
...
\begin{description}
    ...
    \XXitem{/F090/}{funkt:090} Von der Anmelde- und Willkommensseite ist es möglich zur Registrierungsseite zu gelangen.
\end{description}
...
\begin{description}
    ...
    Der nun anonyme Nutzer wird auf die Anmelde- und Willkommensseite weitergeleitet.
...
\begin{description}
    ...
    suchen. Nach Absenden der Suche wird eine Resultatliste nach \hyperref[leist:40]{/L040/} angezeigt.
...
\begin{description}
    ...
    Größe von 4MB hochladen oder sein altes Avatarbild entfernen oder austauschen. %todo link /D/
...
\begin{description}
    ...
    für die er aktive Einreichungen hat (d.h. Ersteller oder Ko-Autor), in einer Listensicht nach \hyperref[leist:40]{/L040/} angezeigt.
...
\begin{description}
    ...
    \XXitem{/F360/}{funkt:360} Dem Nutzer werden seine eigenen Einreichungen in Form einer Liste  nach \hyperref[leist:40]{/L040/}
...
\begin{description}
    \XXitem{/F470/}{funkt:470} Dem Nutzer werden die Informationen \hyperref[d025]{/D025/} zu seiner Einreichung angezeigt.
    Hierzu gehören der Status der Einreichung, das Datum der Einreichung, das zugehörige
    %todo frist für gutachten nur gutachter
    ...
    \hyperref[d025]{/D025/} gelöscht und die Editoren sowie Gutachter per automatisierter Mail informiert.
    Der Nutzer wird vorher auf die Konsequenzen hingewiesen.
    \XXitem{/FW496/}{funkt:496} Der Nutzer kann, wenn verlangt (gelber Status: \hyperref[do025]{/D025/}, Funktion: \hyperref[funkt:702]{/FW702}),
...
\begin{description}
    ...
    \item Über diese werden der Einreicher und beteiligte Ko-Autoren per automatisierter Mail benachrichtigt.
    ...
    \XXitem{/FW703}{funkt:703} Ein Editor kann Revisionenn für Gutachter freischalten, sodass diese für sie sichtbar werden.
    Hierüber werden die beteiligten Gutachter per automatisierter Mail informiert.
...
\begin{description}
    ...
    Für diese Einträge gelten dieselben Funktionalitäten wie für die
    eigenen Einreichungen siehe \hyperref[funkt:370]{/F370}, \hyperref[funkt:380]{/F380/}, \hyperref[funkt:390]{/FW390/}.
    \XXitem{/F740/}{funkt:740} Auf der Seite eines wissenschaftlichen Forums kann der Administrator alle wesentlichen Daten \hyperref[d030]{/D030/}
...
\begin{description}
    ...
    der persistierten Daten wie ein Nutzer auf seiner eigenen Profilseite. %todo link
\end{description}
...
\begin{description}
    ...
    Es muss mindestens ein Editor über einDropdown-Menü, wie in \hyperref[funkt:436]{/F436/} beschrieben, eingetragen werden,
...
\begin{description}
    \XXitem{/F840/}{funkt:840} Ein Administrator kann von der Seite welche die Nutzerliste darstellt auf die Seite zur
    ...
    \XXitem{/F860} Nach erfolgeicher Erstellung eines Nutzers wird der Administrator auf dessen Profilseite weitergeleitet.
\end{description}
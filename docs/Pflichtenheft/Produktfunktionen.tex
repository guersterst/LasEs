...
\begin{description}
    ...
    \XXitem{FW} Während der Eeingabe in das Suchfeld werden bis zu 10 mögliche Suchergebnisse in
...
\begin{description}
    ...
    \XXitem{/F130/} Über eine Suchleiste kann nach bestimmten wissenschaftlichen Foren mittels
    ihres Namens gesucht werden.
    \XXitem{/F140/} Die Einträge lassen sich ahand ihres Namens alphabetisch sortieren.
    \XXitem{FW} Die Einträge lassen sich anhand des Namens durchsuchen.
    \XXitem{/F150/} Durch einen Klick auf den Namen eines Eintrags wird man auf die Seite des
    jeweiligen wissenschaftlichen Forums navigiert.
\end{description}

\subsubsection{Wissenschaftliches Forum}
\begin{description}
    \XXitem{/F130/} Auf der Seite eines wissensch. Forums werden die zugehörigen wesentlichen Daten
    angezeigt. %link /D/
    \XXitem{/F140/} Dem Nutzer werden seine eigenen Einreichungen in Form einer Liste mit Namen, Datum und Status
    angezeigt.
    \XXitem{/F160/} Durch einen Klick auf den Namen einer Einreichung gelangt der Nutzer auf die Übersichtsseite
    dieser Einreichung.
    \XXitem{/F140/} Die Einträge lassen sich nach Namen, Datum und Status
    der Einreichung sortieren.
    \XXitem{FW} Die Einträge lassen sich anhand ihres Namens alphabetisch sortieren.
...
\begin{description}
    ...
    \XXitem{FW} Der Nutzer kann bei Einreichung gewünschte Gutachter vorschlagen.
...
\begin{description}
    ...
    \XXitem{FW }... und nach Namen des Gutachten durchsuchen.
%nav
\end{description}
...
\begin{description}
    ...
    \XXitem{FW} Die Liste kann anhand von Namen und Mailadresse durchsucht werden.
...
\begin{description}
    ...
    \XXitem{FW} Der Administrator kann den Look des wissenschaftlichen Forums durch die folgenden Daten
    verändern. %link

...
\begin{description}
    ...
    Für sie gelten dieselben \hyperref[nut:start]{Funktionalitäten} wie für eigene Einreichungen.
\end{description}
...
\begin{description}
    ...
    Der Editor kann Einreicher und beteiligte Ko-Autoren per Mailto mit vorgefertigter Nachricht hierüber informieren.
...
\begin{description}
    ...
    \XXitem{/F860}{funkt:860} Nach erfolgeicher Erstellung eines Nutzers wird der Administrator auf dessen Profilseite weitergeleitet.
\end{description}
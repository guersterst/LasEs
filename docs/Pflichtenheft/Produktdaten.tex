...
\begin{description}
	...
	\begin{itemize}
		...
		\item die Versionsnummer des zugehörigen Paper/der zugehörigen Revision
		\item Datum und Zeit der Erstellung
	...
	\XXitem{/D050/}{d050} Folgende Daten sind systemweit gespeichert und durch den Administrator in der Oberfläche konfigurierbar:
	\begin{itemize}
	...
	\XXitem{/D055/}{d055} Folgende Daten sind systemweit gespeichert und in der Konfigurationsdatei (siehe INSTALL.txt) konfigurierbar:
	\begin{itemize}
		\item Maximale Uploadgröße für PDFs
		\item Maximale Uploadgröße für Avatarbilder
		\item Listenlänge bei paginierten Listen
		\item Absenderadresse für System E-Mails
		\item Einstellungen für den SMTP Server zum Versenden von System E-Mails
		\begin{itemize}
			\item Nutzername
			\item Passwort
		\end{itemize}

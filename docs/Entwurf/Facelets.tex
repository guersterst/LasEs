...
\begin{samepage}
    ...
    \ftable{
        ...
        \fentry{remove-reviewer}{commandButton}{Entferne einen bestimmten Gutachter}{A,E}
        ...
        \fentry{save-editor}{commandButton}{Speichern der Änderung}{A,E}
...
\begin{samepage}
    ...
    \ftable{
        ...
        \fentry{specialty}{selectOneMenu}{Auswahl von Fachgebieten.}{A}

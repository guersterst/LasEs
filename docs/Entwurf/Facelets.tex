...
\begin{samepage}
    ...
    \begin{itemize}
    	\item \textbf{paginator} Implementation der abstrakten Klasse \emph{Paginator.java}. \todo{hyperref zu Klasse}
    \end{itemize}
...
\ftable{
    ...
    \fentry{welcomeText}{outputText}{Bewerben der Applikation mithilfe einer Kurzbeschreibung.}{AN}
...
\begin{samepage}
    \ftable{
        ...
        \fentry{deadlineBefore}{inputText}{Eingabe eines \emph{spätestens} Deadline.}{Alle}

        \fentry{deadlineAfter}{inputText}{Eingabe eines \emph{frühestens} Deadline.}{Alle}
...
\begin{samepage}
    ...
    \ftable{
        ...
        \fentry{deadlineBefore}{inputText}{Eingabe einer \emph{spätesten} Deadline.}{Alle}

        \fentry{deadlineAfter}{inputText}{Eingabe einer \emph{frühesten} Deadline.}{Alle}
...
\begin{samepage}
    ...
    \ftable{
        ...
        \fentry{addScienceField}{selectOneMenu}{Spezialgebiete des Nutzers}{N}
...
\begin{samepage}
    ...
    Das Anzeigen der Tabellen \emph{editorialPagination}, \emph{reviewPagination} und \emph{submissionPagination} wird genauso gehandhabt, wie auf \hyperref[flt:homepage]{\emph{homepage.xhtml}}.
    ...
    \ftable{
        ...
        \fentry{newScienceField}{selectOneMenu}{Hinzufügen eines neuen Fachgebietes.}{E}

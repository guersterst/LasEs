...
\begin{samepage}
    ...
    \ftable{
        ...
        \fentry{stateSelect}{selectOnMenue}{Filtern des Status von Einreichungen}{Alle}
...
\begin{samepage}
    ...
    \nopagebreak
        ...
        \ftable{
            ...
            \fentry{all}{checkbox}{Anzeigen aller Gutachten.}{E, A}
            \fentry{allLabel}{outputLabel}{Label für all.}{E, A}
            \fentry{locked}{checkbox}{Anzeigen nicht freigeschalteter Gutachten.}{E,A}
            \fentry{lockedLabel}{ouputLabel}{Laberl für locked.}{E, A}
            \fentry{unlocked}{checkbox}{Anzeigen freigeschalteter Gutachten.}{E, A}
            \fentry{unlockedLabel}{ouputLabel}{Laberl für unlocked.}{E, A}
            ...
            \fentry{notSubmittedLabel}{ouputLabel}{Laberl für notSubmitted.}{E, A}
            \fentry{apply}{commandButton}{Wende Filtereinstellungen an.}{Alle}
        }
\end{samepage}
\todo{co authoren verlinkung möglich? und was ist die E-Mail für ein typ?}
...
\begin{samepage}
	...
	\ftable{
		...
		\fentry{sc-field-select}{selectOnMenue}{Filtern der Themengebiete der Foren}{Alle}

		\fentry{deadline-label}{outputLabel}{Label für Filtern nach Deadlines (Abgelaufen/Zukunft)}{Alle}

		\fentry{deadline-select}{selectOnMenue}{Filtern der nach Deadlines}{Alle}
...
\begin{samepage}
	...
	\textbf{userList.xhtml} Editoren und Administratoren erhalten hier einen Überblick über alle Nutzer. Die Seiten sind paginiert.
	\nopagebreak
	...
	\ftable{
		...
		\fentry{stateLabel}{outputLabel}{Label für Filter Rolle des Nutzers}{E,A}

		\fentry{stateSelect}{selectOnMenue}{Filtern der Rolle des Nutzers}{E,A}

		\fentry{apply}{commandButton}{Wende Filtereinstellungen an.}{E,A}

		\fentry{dateUp}{commandButton}{Einreichungen werden aufsteigend angezeigt.}{E,A}

		\fentry{dateDown}{commandButton}{Einreichungen werden absteigend angezeigt.}{E,A}

		\fentry{submissionTable}{dataTable}{Liste aller Nutzer im System.}{E,A}
...
\begin{samepage}
    ...
    \ftable{
        ...
        \fentry{stateSelect}{selectOnMenue}{Filtern des Status von Einreichungen}{G,E,A}

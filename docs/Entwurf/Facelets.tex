...
\begin{samepage}
    ...
    \ftable{
        ...
        \fentry{addScienceField}{p:selectOneListbox}{Spezialgebiete des Nutzers}{N}
...
\begin{samepage}
    ...
    \ftable{
        ...
        \fentry{newScienceField}{p:selectOneListbox}{Hinzufügen eines neuen Fachgebietes.}{E}
...
\begin{samepage}
    ...
    \ftable{
        ...
        \fentry{scienceField}{p:selectOneListbox}{Auswahl von Fachgebieten.}{A}

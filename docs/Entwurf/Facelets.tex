...
Außerdem verfügt ein Administrator über alle Rechte der anderen Rollen.
...
\begin{samepage}
    ...
    \ftable{
        ...
        \fentry{toolBar}{include}{\hyperref[flt:toolbar]{Seitenleiste}}{A,E}
...
\begin{samepage}
    ...
    \ftable{
        ...
        \fentry{reviewState}{selectOneMenu}{Filtern der Gutachten nach ihrem Status.}{E,A,G}

...
\ftable{
        ...
        \fentry{filterLabel}{ouputText}{Label für Filter}{Alle}
        \fentry{stateLabel}{outputText}{Label für Filter vom Status der Einreichung}{Alle}
        \fentry{stateSelect}{selectOnMenue}{Filtern des Status von Einreichungen}{Alle}
        \fentry{dateLabel}{outputText}{Label für Filter von Datum.}{Alle}
...
\ftable{
        \fentry{title}{outputLink}{Titel des Papers.}{Alle}
        \fentry{date}{outputText}{Datum der Einreichung.}{Alle}
        \fentry{state}{outputText}{Status der Einreichung.}{Alle}
        \fentry{forum}{outputLink}{Name des zugehörigen Forums.}{Alle}
}

...
\begin{itemize}
	\item Pfeile, die zur SessionInformation führen wurden aus Gründen der Übersichtlichkeit ausgespart und lediglich als Attribut dargestellt. Die SessionInformation hat natürlich trotzdem keine Getter und Setter.
\end{itemize}

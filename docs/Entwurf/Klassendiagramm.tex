...
\begin{figure}[H]
	\centering
	\includegraphics[height=2cm]{graphics/global_logging}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=4cm]{graphics/global_transport}
\end{figure}
...
\classtable{
	...
	\classentry{Style}{This DTO represents a user interface style.}
	\classentry{Submission}{This DTO represents a submission.}
	\classentry{SubmissionState}{This DTO represents a submissions state.}
	...
	\classentry{LoggerConfig}{Holds configuration information about the logger.}
	\classentry{UIMessage}{This DTO holds the information necessary for constructing a \emph{FacesMessage}.
	It is contained in events used for displaying a message to the user.}
}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=3cm]{graphics/control_internal}
\end{figure}
...
\classtable{
	...
	\classentry{\phantomLabel{class:pagination}Pagination}{Generic class to implement a paginated list of items of a certain type.}
	\classentry{ImageServlet}{Serves avatars and logos.}
	\classentry{ImageServlet}{Serves avatars and logos.}
	\classentry{UIMessageGenerator}{Observes all events concerning \emph{UIMessage}s and creates \emph{FacesMessage}s from them.}
	\classentry{UncheckedExceptionHandler}{Catches all unchecked exceptions and redirects the user to an error page.}
	\classentry{UncheckedExceptionHandlerFactory}{A factory for the \emph{UncheckedExceptionHandler}.}
}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{graphics/control_validation}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=2cm]{graphics/control_util}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{graphics/business_service}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{graphics/business_util}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{graphics/persistence_repository}
\end{figure}
...
Diese Exceptions werden ebenfalls von der \emph{Businessschicht} verwendet.
...
\classtable{
    ...
    \classentry{LogsNotWritableException}{Is thrown when the logger cannot write log files.}

...
\classtable{
	...
	\classentry{UserDoesNotExistException}{Is thrown when the repository tries to query a User from the database that does not exist in the database.}
	...
	\classentry{NoPermissionException}{Is thrown when a user does not have the correct role to complete a certain operation.}
	\classentry{ForumNameDoesNotExistException}{Is thrown when a ScientificForum is queried from the database by name that does not exist.}

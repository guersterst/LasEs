...
\subsection{de.lases.control.exception}
...
Die data transfer Objects, die eine Entity aus der Datenbank nachbilden sind untereinander nicht verzeigert und kennen nur die id ihrer Relationships.

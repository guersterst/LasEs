...
Dies passiert, wenn das Servlet bereit ist, dazu hört ein \code{ServletContextListener} mit der \code{@WebListener}-Annotation auf das \code{contextInitialized}-Event.
...
Es werden \code{Shutdown Hooks} verwendet, um bei einem (evtl.\ unvorhergesehenen) Systemstopp Threads für diese Aufgaben zu starten.

...
\begin{description}
	\XXitem{User}{er:user} Ein Nutzer kann von verschiedene Rollen wahrnehmen, diese werden durch die \emph{is-A}-Spezifizierung modelliert. Die Attribute entsprechen den in \texttt{\textbf{/D010/}} und \texttt{\textbf{/DW015/}} angegebenen Daten.\\Zusätzlich werden auch noch der Passwort-Hash und das zugehörige Salt zum generieren des Hashes gespeichert.
	...
	\XXitem{Submission}{er:submission} Eine Einreichung speichert alle zu einem Einreichungsprozess gehörenden Daten, inklusive der Metadaten, also alle in \texttt{\textbf{/D025/}} und \texttt{\textbf{/DW021/}} angegebenen Daten.

	\XXitem{Review}{er:review} Ein Gutachten ist immer genau einer Einreichung zugeordnet. Es speichert die PDF Datei ab und alle zugehörigen Metadaten.
	...
	\XXitem{Scientific Field}{er:field} Liste aller Fachgebiete bzw. Interessengebiete, die in LasEs verwendet werden. Die Entity wird durch Administratoren verwaltet und neue Einträge hinzugefügt. Nach \texttt{\textbf{/D035/}}.

	\XXitem{System}{er:system} Systemdaten speichern allgemeine Informationen über die Firma, die LasEs einsetzt. Diese werden vom Administrator gesetzt.
	Sie sind in \texttt{\textbf{/D050/}} spezifiziert.

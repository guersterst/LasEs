...
\susubsection{Arbeitspaket \emph{NewSubmission}}
\localauthor{Johannes Garstenauer}
\testlisting{ScientificForumServiceTest}

\susubsection{Arbeitspaket \emph{NewSubmission}}
\localauthor{Johannes Garstenauer}
\testlisting{PaperServiceTest}
...
\localauthor{Sebastian Vogt}
\testlisting{SystemSettingsRepositoryTest}

\subsubsection{Arbeitspaket \emph{Science Field}}
\localauthor{Stefanie Gürster}
\testlisting{ScienceFieldServiceTest}
...
\localauthor{Sebastian Vogt}
\testlisting{NewUserBackingTest}

\subsubsection{Arbeitspaket \emph{UserList}}
\localauthor{Stefanie Gürster}
\testlisting{UserServiceTest}

\susubsection{Arbeitspaket \emph{NewReview}}
\localauthor{Johannes Garstenauer}
\testlisting{ReviewServiceTest}

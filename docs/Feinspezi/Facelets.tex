...
\begin{samepage}
	...
	\ftable{
		...
		\fentry{forumName}{inputText}{Name des Forums.}{value="\#\{scientificForumBacking.scientificForum.name\}"}{readonly="\#\{!scientificForumBacking.isViewerEditor\}"}{required="true"}

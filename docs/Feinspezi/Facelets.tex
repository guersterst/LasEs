...
\todo{Suffix:}
 graphicImage = gim, link = lnk, inputText = itxt, commandButton = cbtn, messages = msgs, dataTable = dtbl, selectOneMenu = slctom, panelGrid = pgrd, commandLink = clnk, inputSecret = iscrt

...
\begin{samepage}
	...
	\ftable{newUser}{\textbf{newUser.xhtml} Der Administrator kann hier einen neuen Nutzer anlegen.}{
		\fentry{password-iscrt}{<h:inputSecret>}{Angabe des Passworts.}{value="\#\{newUserBacking.newUser.passwordNotHashed\}"}{render="\#\{newUserBacking.sessionInformation.user.admin\}"}{passwordValidator \newline validateLength \newline minimum="8" \newline maximum="100" \newline required="true" \newline requiredMessage=\newline "\#\{message.password\}"}

		\fentry{firstname-itxt}{<h:inputText>}{Angabe des Vornamen.}{value="\#\{newUserBacking.newUser.firstName\}"}{render="\#\{newUserBacking.sessionInformation.user.admin\}"}{required="true" \newline requiredMessage=\newline maxLength="\#\{Const.FIRST\_NAME\_MAX\}"}

		\fentry{lastname-itxt}{<h:inputText>}{Angabe des Nachnamen.}{value="\#\{newUserBacking.newUser.lastName\}"}{render="\#\{newUserBacking.sessionInformation.user.admin\}"}{required="true" \newline requiredMessage=\newline "\#\{message.lastName\}" \newline maxLength="\#\{Const.LAST\_NAME\_MAX\}"}

		\fentry{titel-itxt}{<h:inputText>}{Angabe eines Titels.}{value="\#\{newUserBacking.newUser.title\}"}{render="\#\{newUserBacking.sessionInformation.user.admin\}"}{/}

		\fentry{e-mail-itxt}{<h:inputText>}{Angabe einer E-Mail-Adresse.}{value="\#\{newUserBacking.newUser.emailAddress\}"}{render="\#\{newUserBacking.sessionInformation.user.admin\}"}{emailAddressExistsValidator \newline emailAddressLayoutValidator \newline required="true" \newline requiredMessage=\newline "\#\{message.email\}"}

		\fentry{is-admin-cbx}{<h:selectBooleanCheckbox>}{Zuordnung einer Administratorenrolle.}{value="\#\{newUserBacking.admin\}"}{render="\#\{newUserBacking.sessionInformation.user.admin\}"}{/}

		\fentry{abort-btn}{<h:commandButton>}{Abbruch des Vorgangs: Nutzererstellen.}{value="\#\{newUserBacking.abort\}"}{render="\#\{newUserBacking.sessionInformation.user.admin\}"}{/}

		\fentry{save-btn}{<h:commandButton>}{Speichern des neuen Nutzers.}{value="\#\{newUserBacking.saveUser\}"}{render="\#\{newUserBacking.sessionInformation.user.admin\}"}{/}
...
\begin{samepage}
	...
	\ftable{administration}{\textbf{administration.xhtml} Hier kann ein Administrator Konfigurationen vornehmen.}{
		\fentry{select-theme-slctom}{<h:selectOneMenu>}{Auswahl eines Farbthemas.}{value="\#\{administrationBacking.systemSettings.style\}"}{render="\#\{administrationBacking.sessionInformation.user.admin\}"}{/}
		...
		\fentry{logo-gimg}{<h:graphicImage>}{Logo des Systems.}{value="\#\{'/image/logo'\}"}{render="\#\{administrationBacking.sessionInformation.user.admin\}"}{/}

		\fentry{change-logo-ifile}{<h:inputFile>}{Hochladen eines neuen Logos.}{title="\#\{help.uploadNewLogo\}"\newline value="\#\{administrationBacking.uploadedImage\}"}{render="\#\{administrationBacking.sessionInformation.user.admin\}"}{/}

		\fentry{welcome-heading-itxt}{<h:inputText>}{Angabe einer Überschrift auf der \emph{welcomepage}}{value="\#\{administrationBacking.systemSettings.headlineWelcomePage\}"}{render="\#\{administrationBacking.sessionInformation.user.admin\}" }{required="true" \newline requiredMessage=\newline "\#\{message.welcomeHeading\}" \newline maxLength="\#\{Const.WELCOME\_HEADING\_MAX\}"}

		\fentry{welcome-text-itxt}{<h:inputTextArea>}{Angabe eines Textes auf der \emph{welcomepage}}{value="\#\{administrationBacking.systemSettings.shortMessageWelcomePage\}"}{render="\#\{administrationBacking.sessionInformation.user.admin\}"}{required="true" \newline requiredMessage=\newline "\#\{message.welcomeText\}" \newline maxLength="\#\{Const.WELCOME\_DESCRIPTION\_MAX\}"}

		\fentry{institution-itxt}{<h:inputText>}{Angabe des Namens der Einrichtung.}{value="\#\{administrationBacking.systemSettings.companyName\}"}{render="\#\{administrationBacking.sessionInformation.user.admin\}"}{required="true" \newline requiredMessage=\newline "\#\{message.institution\}" \newline maxLength="\#\{Const.SYSTEM\_COMPANY\_NAME\_MAX\}"}

		\fentry{imprint-itxt}{<h:inputTextArea>}{Angabe des Impressums der Einrichtung.}{value="\#\{administrationBacking.systemSettings.imprint\}"}{render="\#\{administrationBacking.sessionInformation.user.admin\}"}{required="true" \newline requiredMessage=\newline "\#\{message.imprint\}"}

		\fentry{abort-btn}{<h:commandButton>}{Abbruch des Änderungsvorgangs.}{value="\#\{labels.abort\}"\newline action="\#\{administrationBacking.abort\}"}{render="\#\{administrationBacking.sessionInformation.user.admin\}"}{/}

		\fentry{save-btn}{<h:commandButton>}{Speichern der Änderungen.}{value="\#\{labels.save\}"\newline action="\#\{administrationBacking.save\}"}{render="\#\{administrationBacking.sessionInformation.user.admin\}"}{/}

		\fentry{new-user-link}{<h:link>}{Weiterleitung zu \emph{newUser.xhtml}.}{value="\#\{labels.gotoNewUser\}" \newline outcome="/views/authenticated/newUser"}{render="\#\{administrationBacking.sessionInformation.user.admin\}"}{/}

		\fentry{new-scientific-forum-link}{<h:link>}{Weiterleitung zu \emph{newScientificForum.xhtml}.}{value="\#\{labels.gotoNewScientificForum\}" \newline outcome="/views/authenticated/newScientificForum"}{render="\#\{administrationBacking.sessionInformation.user.admin\}"}{/}
	}
\end{samepage}
...
\begin{samepage}
	...
	\fentry{forum-name-itxt}{<h:inputText>}{Angabe des Name des Forums.}{value="\#{newScientificForumBacking.newScientificForum.name}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{required="true" \newline requiredMessage=\newline "\#\{message.forumName\}" \newline maxLength="\#\{Const.FORUM\_NAME\_MAX\}"}

	\fentry{editors-list}{<h:dataTable>}{Liste der Editoren}{value="\#{newScientificForumBacking.editors}"}{render="\#{toolbarBacking.sessionInformation.user.admin}"}{/}

	\fentry{email-editor-itxt}{<h:inputText>}{Angabe der E-Mail-Adresse eines Editor.}{value="\#{newScientificForumBacking.newEditorInput.emailAddress}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{emailAddressValidator \newline emailAddressLayoutValidator \newline required="true" \newline requiredMessage=\newline "\#\{message.email\}"}

	\fentry{add-editor-btn}{<h:commandButton>}{Hinzufügen eines Editors in eine Liste.}{value="\#\{labels.add\}"\newline  action="\#\{newScientificForumBacking.addEditor\}"\newline title="\#\{help.addEditor\}"}{render="\#\{newScientificForumBacking.sessionInformation.user.admin\}"}{/}

	\fentry{delete-editor-btn}{<h:commandButton>}{Löschen des zugehörigen Editors von der Liste.}{value="\#\{labels.remove\}"\newline  action="\#\{newScientificForumBacking.removeEditor(var)\}"\newline title="\#\{help.removeEditor\}"}{render="\#\{newScientificForumBacking.sessionInformation.user.admin\}"}{/}

	\fentry{deadline-itxt}{<h:inputText>}{Hinzufügen einer Deadline des Forums.}{value="\#\{newScientificForumBacking.newScientificForum.deadline\}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{converterDateTime \newline type="localDate"}

	\fentry{description-itxt}{<h:inputTextArea>}{Angabe einer Kurzbeschreibung.}{value="\#\{newScientificForumBacking.newScientificForum.description\}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{required="true" \newline requiredMessage=\newline "\#\{message.description\}" \newline maxLength="\#\{Const.FORUM\_DESCRIPTION\_MAX\}"}

	\fentry{url-itxt}{<h:inputText>}{Link zur Konferenz oder zum Journal.}{value="\#\{newScientificForumBacking.newScientificForum.url\}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{maxLength="\#\{Const.FORUM\_URL\_MAX\}"}

	\fentry{review-manual-itxt}{<h:inputTextArea>}{Angabe einer Anleitung für eine Begutachtung.}{value="\#\{newScientificForumBacking.newScientificForum.reviewManual\}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{required="true" \newline requiredMessage=\newline "\#\{message.manual\}" \newline maxLength="\#\{Const.REVIEW\_MANUAL\_MAX\}"}

	\fentry{science-field-list}{<h:outputText>}{Liste der ausgewählten Fachgebiete.}{value="\#\{newScientificForumBacking.selectedScienceFields\}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{/}

	\fentry{science-field-list}{<p:selectOneListbox>}{Auswahl von Fachgebieten.}{value="\#\{newScientificForumBacking.scienceFields\}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{/}
	
	\fentry{field-lst}{<f:selectItems>}{Liste des Auswahlmöglichkeiten}{value="\#\{newScientificForumBacking.scienceFields\}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{/}

	\fentry{new-science-field-itxt}{<h:inputText>}{Hinzufügen neuer Fachgebiete.}{value="\#\{newScientificForumBacking.newScienceFieldInput.name\}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{required="true" \newline requiredMessage=\newline "\#\{message.newScienceField\}" \newline maxLength="\#\{Const.SCIENCE\_FIELD\}"}

	\fentry{add-science-field-btn}{<h:commandButton>}{Ausführen der Hinzufüge-Aktion.}{value="\#\{labels.add\}"\newline action="\#\{newScientificForumBacking.addScienceField\}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{/}

	\fentry{save-btn}{<h:commandButton>}{Speichern des neuen Forums.}{value="\#\{labels.save\}"\newline action="\#\{newScientificForumBacking.create\}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{/}

	\fentry{abort-btn}{<h:commandButton>}{Abbruch des Erstellungsprozesses.}{value="\#\{labels.abort\}"\newline action="\#\{newScientificForumBacking.abort\}"}{render="\#{newScientificForumBacking.sessionInformation.user.admin}"}{/}
}
\end{samepage}

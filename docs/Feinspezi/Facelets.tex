...
\begin{samepage}
	...
	\ftable{
		\fentry{user-pg}{<pg:pagination>}{Die Tabelle enthält eine Paginierung.}{paginator="\#\{userListBacking.userPagination\}"}{rendered="\#\{userListBacking.sessionInformation.user.isEditor\}"}{/}

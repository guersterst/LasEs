...
\todo{Suffix:}
 graphicImage = gim, link = lnk, inputText = itxt, outputText = otxt, commandButton = cbtn, messages = msgs, dataTable = dtbl, selectOneMenu = slctom, panelGrid = pgrd, commandLink = clnk, inputSecret = iscrt, inputFile = ifile, column = clmn
...
\begin{samepage}
	...
	\emph{paperPagination} enthält die Spalten: Version, Datum, Sichtbarkeit und Download.
	...
	\ftable{
		...
		\fentry{release-revision-ssc}{<ssc:sortsearchcolumn>}{Spalte für den Freigabestatus.}{paginator="\#\{submissionBacking.paperPagination\}"\newline columnNamei18n="\#\{label.releaseRevision\}"}{/}{/}

		\fentry{show-release-revision-otxt}{<h:outputText>}{Status der Freischaltung. }{value="\#\{label.releasedRevision\}"}{rendered="\#\{not submissionBacking.sessionInformation.user.editor\}"}{/}
...
\begin{samepage}
Die Spalte zum Download der einzelnen Paper ist wie folgt definiert:
...
\begin{samepage}
	...
	\emph{reviewPagination} enthält die Spalten: Version, Gutachter, Datum, Status, Empfehlung, Kommentar und Download.
	...
	\ftable{
		...
		\fentry{reviewer-lnk}{<h:link>}{Namen des Gutachters.}{}{E,G}{}{}

...
\todo{ScientificForumsname gibt es nicht}
...
\begin{samepage}
	...
	\ftable{
		...
		\fentry{forum-lnk}{<h:link>}{Zugehöriges Forum der Einreichung.}{value="\#\{var.scientificForum.name\}" outcome="/facelets/authenticated/scientificForum" \newline includeViewParams="true"}{/}{/}

...
\begin{samepage}
	...
	\ftable{
		...
		\fentry{editor-list}{<h:dataTable>}{Liste der verantwortliche Editoren.}{value="\#\{scientificForumBacking.editors\}"}{/}{/}

		\fentry{new-editor-itxt}{inputText}{Angabe der E-Mail eines Editors.}{E}{}{required="true"\newline }

...
%   \end{frame}
    ...
    \begin{frame}{Ordnerstruktur}
        ...
        \includegraphics[height=0.5\textheight]{graphics/w2_folder_final_smaller}
        \begin{itemize}
            %Labels, Tooltips und UI-Nachrichten in mehreren jew. einsprachigen Resource-Bundles.
            ...
            % um sie vor unautorisierten
            %Zugriffen schützen.
            \pause
            \item Tests unterteilt
            % Fein nach Paketen, Performance und Selenium unterteilt
            %-> um um zu modularem Testing anzuregen.
        \end{itemize}
    \end{frame}
    ...
    % Ausschnitthaftes Veispiel des Aufbaus der Seite zur Einreichung einer Darstellung
...
\&       \includegraphics[height=0.1\textheight]{graphics/facelet/fac_event}
    ...
    \begin{frame}{Typische Klasse \textbf{Businessschicht}:}
        ...
        \begin{itemize}
            ...
            \item %Todo woanders? : bei race-conditions
    ...
    \begin{frame}{Typische Klasse \textbf{Persistenzschicht}:}
        ...
        \begin{itemize}
            ...
            % Bietet ebenfalls ähnliche Methoden wie Services an:
            % -> einheitliche, leichte Interfaces für Sie
            \item add()
            \centering
            ...
            %todo gibt es hier mehr zu sagen?
            %todo hier race-conditions?
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{Auftreten einer unchecked Exception}
        ...
        \begin{itemize}
            ...
            %todo kann man machen muss man aber nicht
            %todo erreich man die alte Seite durch zurück Pfeil?
            %todo zwei simultan? unchecked 2x o. unchecked + checked
            %todo -> Prototyp ausprobieren
        \end{itemize}
    \end{frame}
